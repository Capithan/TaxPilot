...
DO NOT skip this step or proceed until the user confirms their information is correct.`,
        ...
        completionCheck: (state) => {
            ...
            const summaryShown = state.stageData.summary_review;
            return {
...
This checklist is based on their specific income types, deductions, and special situations.`,
        ...
        completionCheck: (state) => {
            const checklistGenerated = state.stageData.document_checklist;
            return {
...
The system automatically schedules appointment reminders when the appointment is created.`,
        ...
        completionCheck: (state) => {
            const remindersCreated = state.stageData.reminders_setup;
            return {
 ...
 */
export function initializeFlow(clientId, sessionId) {
    const state = {
        clientId,
        sessionId,
 ...
 */
export function getFlowState(clientId) {
    return activeFlows.get(clientId) || null;
}
/**
 * Get or create flow state
 */
export function getOrCreateFlowState(clientId, sessionId) {
 ...
 */
export function getFlowStatus(clientId) {
 ...
 */
export function advanceFlow(clientId, stageData) {
    const state = activeFlows.get(clientId);
    if (!state) {
        return null;
    }
 ...
 */
export function updateFlowState(clientId, updates) {
    const state = activeFlows.get(clientId);
    if (!state) {
        return null;
    }
 ...
 */
export function confirmSummary(clientId) {
    const state = activeFlows.get(clientId);
    if (!state) {
        return null;
    }
 ...
 */
export function setSchedulingPreferences(clientId, preferences) {
    const state = activeFlows.get(clientId);
    if (!state) {
        return null;
    }
 ...
 */
export function setSelectedTaxPro(clientId, taxProId) {
    const state = activeFlows.get(clientId);
    if (!state) {
        return null;
    }
 ...
 */
export function getFlowProgressDisplay(clientId) {
    const state = activeFlows.get(clientId);
    if (!state) {
 ...
 */
export function syncFlowWithState(clientId, sessionId) {
    const client = db.getClient(clientId);
 ...
 */
export function getNextActionInstructions(clientId) {
