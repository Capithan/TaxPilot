...
export function generateDocumentChecklist(clientId) {
...
export function getDocumentChecklist(clientId) {
    return db.getChecklist(clientId) || null;
}
export function markDocumentCollected(clientId, documentId) {
...
export function formatChecklistForDisplay(checklist) {
...
export function getPendingDocuments(clientId) {
    const checklist = db.getChecklist(clientId);
    if (!checklist)
        return [];
    return checklist.documents.filter((d) => !d.collected && d.required);
}
export function getGigEconomyDocuments(employers) {
    const documents = [];
