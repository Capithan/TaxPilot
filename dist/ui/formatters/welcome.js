 ...
 */
import { structuredResponse, selectionCard, stepProgress, infoCard, checklist, toolAction, messageAction, } from '../components.builders.js';
/** Build the home screen shown on first load. */
export function formatWelcomeScreen() {
