 ...
 */
import { structuredResponse, primaryButton, secondaryButton, dangerButton, toolAction, messageAction, formField, formGroup, multiSelect, selectionCard, stepProgress, appointmentSummary, taxProCard, checklist, carousel, } from '../components.builders.js';
// ═══════════════════════════════════════════════════════════════════════════════
// HOME SCREEN — Welcome
// ═══════════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════════
export function buildIntakePersonalInfo(sessionId, clientId) {
...
export function buildIntakeFilingStatus(sessionId) {
    return structuredResponse('intake', 'process_intake_response')
...
// ═══════════════════════════════════════════════════════════════════════════════
export function buildSummaryReview(clientId) {
...
// DOCUMENT CHECKLIST
// ═══════════════════════════════════════════════════════════════════════════════
export function buildDocumentChecklist(clientId) {
...
// TAX PRO MATCHING
// ═══════════════════════════════════════════════════════════════════════════════
export function buildTaxProRecommendations(clientId) {
...
// APPOINTMENT BOOKING
// ═══════════════════════════════════════════════════════════════════════════════
export function buildAppointmentBooking(clientId, taxProId) {
...
// ═══════════════════════════════════════════════════════════════════════════════
export function buildAppointmentConfirmation(clientId, appointmentId) {
...
//# sourceMappingURL=structured.examples.js.map