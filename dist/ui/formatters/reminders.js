...
export function formatRemindersCreated(reminders, clientId) {
...
export function formatRemindersList(reminders, clientId) {
...
export function formatReminderSent(result, reminderId) {
