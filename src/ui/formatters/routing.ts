...
import { ui, card as cardBuilder } from '../builders.js';
import type { UIResponse, UIBadge } from '../types.js';
import type {
  ClientProfile,
  TaxProfessional,
  Appointment,
...
function complexityBadge(level: string, score?: number): UIBadge {
  switch (level) {
...
function complexityInterpretation(level: string): string {
  switch (level) {
...
function slotsText(pro: TaxProfessional): string {
...
export function formatComplexityScore(
  clientId: string,
  score: number,
...
export function formatTaxProRecommendations(
  clientId: string,
  recommended: TaxProfessional | null,
  reason: string,
...
export function formatAppointmentEstimate(estimate: {
...
export function formatAppointmentCreated(
...
export function formatTaxProList(taxPros: TaxProfessional[]): UIResponse {
...
export function formatClientProfile(client: ClientProfile): UIResponse {
